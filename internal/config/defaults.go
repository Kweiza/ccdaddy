...
//
// strategy.Config's zero value is already the full §7.2 default set and
...
// than an omission. §7.3 requires two independent opt-ins for unattended
// spending and this is one of them, so the default refuses.
